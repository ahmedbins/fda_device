...
export default function IeceeExplorerPage() {
  ...
  const activeFilters = countIeceeFilters(filters);
        ...
        <section className="results-panel">
          <div className="results-toolbar">
            ...
            <div className="toolbar-actions">
              ...
              <label className="page-size">Rows <select value={applied.pageSize} onChange={(event) => changePageSize(Number(event.target.value))}>{IECEE_PAGE_SIZES.map((size) => <option key={size} value={size}>{size}</option>)}</select></label>
