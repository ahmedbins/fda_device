...
import { FCC_EAS_API, FCC_SEARCH_URL, FCC_SOURCE_LABEL, fccLocation, fccRecordsInWindow, fccSourcePresentation, openFccEasRecord, parseFccScopes, type FccSearchResult, type NormalizedFccRecord } from "./fcc-core";
